...
(async function () {
  ...
  function buildPublicRestaurantDraft(r) {
    ...
    return {
      ...
      catalog_label_en: r.catalog_label_en || '', catalog_label_ar: r.catalog_label_ar || '',
      featured_title_en: r.featured_title_en || '', featured_title_ar: r.featured_title_ar || '',
      catalog_heading_en: r.catalog_heading_en || '', catalog_heading_ar: r.catalog_heading_ar || '',
